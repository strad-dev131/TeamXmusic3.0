...
from TEAMXMUSIC.mongo.pretenderdb import (
    impo_off, impo_on, check_pretender,
    add_userdata, get_userdata, usr_data
)
from TEAMXMUSIC.utils.admin_filters import admin_filter
...
""".format(
    ...
    if msg != "":
        await message.reply_photo("https://files.catbox.moe/timwpo.jpg", caption=msg)
